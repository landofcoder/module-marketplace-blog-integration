...
namespace Lofmp\SellerBlog\Model\ResourceModel\Category\Grid;
 ...
 */
class Collection extends \Magefan\Blog\Model\ResourceModel\Category\Collection implements SearchResultInterface
{
    /**
     * @var string
     */
    protected $_referenceTableName = "magefan_blog_category_seller";

    /**
     * @var string
     */
    protected $_fieldId = 'category_id';
