 ...
 */
namespace Lofmp\SellerBlog\Block\Marketplace\Post\Helper\Form\Gallery;

use Magento\Framework\App\ObjectManager;
use \Lof\MarketPlace\Block\Product\Helper\Form\Gallery\Uploader;//Magento\Backend\Block\Media\Uploader;
...
class Content extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Lofmp_SellerBlog::post/helper/gallery.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getUploader()->getConfig()->setUrl(
            $this->_urlBuilder->getUrl('sellerblog/post_upload/gallery')
        )->setFileField(
            'image'
        )->setFilters(
            [
