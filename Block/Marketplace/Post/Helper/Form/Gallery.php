 ...
 * Blog post gallery
 */
namespace Lofmp\SellerBlog\Block\Marketplace\Post\Helper\Form;
...
class Gallery extends \Magento\Framework\View\Element\AbstractBlock
{
     ...
     * @var string
     */
    protected $formName = 'sellerblog_post_form';
    ...
    public function getContentHtml()
    {
        ...
        if (!$content) {
            $content = $this->getLayout()->createBlock(
                \Lofmp\SellerBlog\Block\Marketplace\Post\Helper\Form\Gallery\Content::class,
                '',
                [
                    'config' => [
                        'parentComponent' => 'sellerblog_post_form.sellerblog_post_form.block_gallery.block_gallery'
                    ]
                ]
            );
        }
